var dataLayer = new Promise(resolve => {
        ...
        resolve({
            days: {
                sun: {day: 'sunday',hours: 'CLOSED',id: 0},mon: {day: 'monday',hours: '9:00 am - 6 pm',id: 1},tue: {day: 'tuesday',hours: 'CLOSED',id: 2},wed: {day: 'wednesday', hours: '9:30 am - 4:30 pm',id: 3},thur: {day: 'thursday', hours: '10:00 am - 4:30 pm',id: 4},fri: {day: 'friday', hours: '9:00 am - 6:00 pm',id: 5},sat: {day: 'saturday', hours: 'CLOSED',id: 6}
            }
        }); // end data stub
    }).then(response => {
            ...
            for (key in response.days) {
                for (id in response.days[key]) {
                    if(response.days[key].id === day ){
                        if(response.days[key].hours == 'CLOSED'){
    ...
    buttonParent = document.querySelector('.day-list');